...
const ErrorNotFoundPage: FC = () => {
    return (
        <div className="container" id={styles.svg_dave}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 250">
                ...
                <g id="Dave-clipper" clipPath="url(#center-circle-clip)">
                    <g id={styles.Dave}>
                        ...
                        <g id={styles.eyes} fill="#263D52">
                            <circle
                                id="eyes-left"
                                style={{ transformOrigin: "256.4px 114.3px" }}
                                className={styles.blinking_eyes}
                                cx="256.4"
                                cy="114.3"
                                r="5.9"
                            />
